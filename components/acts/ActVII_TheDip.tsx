            ...
            <Step data={0}>
              <div className="step-card my-64 opacity-50 transition-opacity duration-300 data-[active=true]:opacity-100" data-active={currentStepIndex === 0}>
                <div className="bg-white/5 border border-white/10 p-8 rounded-2xl backdrop-blur-md shadow-xl">
                  ...
                  <p className="text-white/70 leading-relaxed text-lg">The 2021 Assembly election appeared to be a setback on paper: the NDA lost Nemom and returned to zero seats in the assembly. Critics rushed to write obituaries.</p>
                </div>
              </div>
            </Step>
            ...
            <Step data={1}>
              <div className="step-card my-64 opacity-50 transition-opacity duration-300 data-[active=true]:opacity-100" data-active={currentStepIndex === 1}>
                <div className="border-l-4 border-bjp-saffron bg-gradient-to-r from-bjp-saffron/10 to-transparent p-8 rounded-r-2xl shadow-xl">
                  <div className="inline-block px-3 py-1 bg-bjp-saffron/20 rounded-full text-xs font-bold tracking-wider text-bjp-saffron mb-4">2021 Assembly Margins</div>
                  <h3 className="text-2xl font-heading text-white mb-4">Shifting Ground</h3>
                  <p className="text-white/70 leading-relaxed text-lg mb-4">However beneath the surface, the vote share held steady at roughly 11.3%. In crucial A-class constituencies like Manjeshwar, Kasaragod, and Palakkad (where Metro Man E. Sreedharan fought), the margins of defeat were razor-thin.</p>
                </div>
              </div>
            </Step>
