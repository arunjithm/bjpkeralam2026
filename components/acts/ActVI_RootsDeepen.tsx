      ...
      <div className="flex flex-col md:flex-row w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full md:w-1/2 md:pl-16 pb-32">
          <div className="sticky top-24 mb-16 md:mb-32 z-10 bg-white/90 backdrop-blur-sm py-4 border-b border-bjp-saffron/20">
            <h2 className="text-bjp-saffron uppercase tracking-widest text-sm font-bold">Act VI</h2>
            <h1 className="statement-header text-3xl md:text-5xl mt-2">Roots <span className="saffron-header">Deepen</span></h1>
            <p className="text-ink-700 text-sm mt-2 font-medium">2020 Local Body Elections</p>
          </div>
            ...
            <Step data={0}>
              <div className="step-card my-32 md:my-64 opacity-50 transition-opacity duration-300 data-[active=true]:opacity-100" data-active={currentStepIndex === 0}>
                <div className="glass-card p-8">
                  ...
                  <p className="text-ink-700 leading-relaxed text-lg">The true test of a party&apos;s permanence in Keralam is its local machinery. In 2020, the BJP proved that it was no longer a party of just &apos;influential candidates&apos; but possessed deep grassroots cadre strength.</p>
                </div>
              </div>
            </Step>
            ...
            <Step data={1}>
              <div className="step-card my-32 md:my-64 opacity-50 transition-opacity duration-300 data-[active=true]:opacity-100" data-active={currentStepIndex === 1}>
                <div className="glass-card p-8 border-l-4 border-bjp-saffron">
                  <div className="inline-block px-3 py-1 bg-bjp-saffronsoft/30 rounded-full text-xs font-bold tracking-wider text-ink-950 mb-4 uppercase">2020 Local Bodies</div>
                  <h3 className="font-black text-2xl text-ink-950 mb-4">Shifting Ground</h3>
                  <p className="text-ink-700 leading-relaxed text-lg mb-4">The party retained Palakkad Municipality and captured the Pandalam Municipality outright, while finishing as a formidable opposition in Thiruvananthapuram Corporation with 34 seats.</p>
                </div>
              </div>
            </Step>
